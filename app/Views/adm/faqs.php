<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 vh-100">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="<?= base_url('/faq/add') ?>" class="btn btn-personal btn-sm" title="Adiciona uma nova pergunta">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('/faq/edit/' . $n->id) ?>" title="Editar"><i class="fas fa-edit"></i></a>
                                    <a href="<?= base_url('/faq/delete/' . $n->id) ?>" title="Deletar"><i class="fas fa-minus-circle"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
