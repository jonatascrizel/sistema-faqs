<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 vh-100">
  ...
  <div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
      ...
      <form id="formCadastro" method="post" action="<?= base_url('faq/store') ?>" class="mb-5 mt-3">
        ...
        <div class="mb-3">
          <label for="nome" class="form-label">Categorias:</label>
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="checkbox" id="evento<?=$t->id?>" name="evento[]" value="<?=$t->id?>" />
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="pergunta" name="pergunta" value="" />
        </div>
